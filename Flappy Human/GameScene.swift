...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    func createScene(){
        ...
        birdSprites.append(birdAtlas.textureNamed("flappybaby1"))
        birdSprites.append(birdAtlas.textureNamed("flappybaby2"))
        birdSprites.append(birdAtlas.textureNamed("flappybaby3"))
        birdSprites.append(birdAtlas.textureNamed("flappybaby4"))
